...
const intersectionsForEntity = (entity: Entity): any[] =>
  (entity.update as jasmine.Spy).calls.mostRecent().args[0];
...
describe("Entity Updater", () => {
  ...
  describe("Collision Detection", () => {
    ...
    it("Bugs facing away from each other are not intersecting if they're sorta far away", () => {
      const entities = [
        new Bug(0, {
          pos: new Victor(6, 0),
          direction: new Victor(1, 0),
          size: new Victor(10, 10),
        }),
        new Bug(2, {
          pos: new Victor(0, 0),
          direction: new Victor(-1, 0),
